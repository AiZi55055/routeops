...
exports.seedMock = seedMock;
const firestore_1 = require("firebase/firestore");
const firebase_1 = require("@/lib/firebase");
async function seedMock(companyId, messengerId) {
    // 1) ensure a messenger doc exists
    await (0, firestore_1.addDoc)((0, firestore_1.collection)(firebase_1.db, "messengers"), {
    ...
    for (const j of jobs) {
        await (0, firestore_1.addDoc)((0, firestore_1.collection)(firebase_1.db, "jobs"), j);
    }
